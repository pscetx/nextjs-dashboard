...
export default function ElegantCursor() {
  ...
  return (
    <div
      className={`hidden md:block pointer-events-none fixed top-0 left-0 w-6 h-6 rounded-full transition-transform duration-100 ease-out 
        ${clicked ? "bg-amber-800" : "bg-gray-400"} opacity-40`}
      style={{
