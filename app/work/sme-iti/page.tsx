    ...
    <div className="p-6 w-full">
      <div className='flex flex-col items-center justify-center space-y-6'>
        ...
        <p className="mt-4 text-xl text-gray-800 text-center max-w-3xl mx-auto italic">
          A simple tool designed to help small and medium-sized enterprises identify vulnerabilities, evaluate their security posture, and strengthen their defenses against cyber threats.
        </p>
