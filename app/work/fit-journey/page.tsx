  ...
  return (
    <div className="p-6 w-full">
      ...
      <div className='flex flex-col items-center justify-center text-gray-600 text-lg space-y-6 md:space-y-10'>
        ...
        <Image className='rounded-xl' src="/fj-Thumbnail.jpg" width={1000} height={50} alt="Thumbnail" priority />
        <Image className='rounded-xl' src="/fj-Overview.jpg" width={1000} height={50} alt="Overview" priority />
        <Image className='rounded-xl' src="/fj-Design System.jpg" width={1000} height={50} alt="Design System" priority />
        <Image className='rounded-xl' src="/fj-Components.jpg" width={1000} height={50} alt="Components" priority />
        <Image className='rounded-xl' src="/fj-Showcase 1.jpg" width={1000} height={50} alt="Showcase #1" priority />
        <Image className='rounded-xl' src="/fj-Showcase 2.jpg" width={1000} height={50} alt="Showcase #2" priority />
        <Image className='rounded-xl' src="/fj-Showcase 3.jpg" width={1000} height={50} alt="Showcase #3" priority />
        <div>
          <Image className='rounded-xl' src="/fj-Prototype.jpg" width={1000} height={50} alt="Prototype" priority />
          ...
          <Image className='rounded-xl' src="/fj-Thank You.jpg" width={1000} height={50} alt="Thank You" priority />
        </div>
      </div>
    </div>
  );
