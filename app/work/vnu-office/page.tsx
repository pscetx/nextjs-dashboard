    ...
    <div className="p-6 w-full">
      <div className='flex flex-col items-center justify-center space-y-6'>
        ...
        <p className="mt-4 text-xl text-gray-800 text-center max-w-3xl mx-auto italic">
          A streamlined mobile platform designed to simplify internal communication, document management, and task coordination for staff and students across departments.
        </p>
